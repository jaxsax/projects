...
var LinkTableColumns = struct {
	...
	ID:        "links.id",
	CreatedTS: "links.created_ts",
	CreatedBy: "links.created_by",
	Link:      "links.link",
	Title:     "links.title",
	ExtraData: "links.extra_data",
	DeletedAt: "links.deleted_at",
}
...
var LinkWhere = struct {
	...
	DeletedAt: whereHelperint64{field: "\"links\".\"deleted_at\""},
}
...
var (
	linkAllColumns            = []string{"id", "created_ts", "created_by", "link", "title", "extra_data", "deleted_at"}
	linkColumnsWithoutDefault = []string{}
	linkColumnsWithDefault    = []string{"id", "created_ts", "created_by", "link", "title", "extra_data", "deleted_at"}
