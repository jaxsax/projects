    ...
    <>
      <nav className="bg-gray-800 sm:flex sm:justify-between sm:px-4 sm:py-2">
        ...
        >
          <Link
            to="/login"
            className="block px-2 py-1 text-white font-semibold hover:bg-gray-500 rounded"
          >
            Login
          </Link>
        </div>
